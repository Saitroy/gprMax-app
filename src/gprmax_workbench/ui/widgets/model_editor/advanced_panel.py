...
class AdvancedPanel(QWidget):
    ...
    def __init__(
        ...
        self._advanced_warning.setObjectName("AdvancedWarning")
        self._advanced_warning.setWordWrap(True)
        ...
        editor_layout.addWidget(self._advanced_warning)
    ...
    def retranslate_ui(self) -> None:
        ...
        self._advanced_warning.setText(self._localization.text("editor.advanced.warning"))
